...
function SeatBooking() {
  ...
  const bookedSeats =
    bookedTheater.find(
      (theater) =>
        theater.theaterName === theaterNameLocal && theater.time === hr,
    )?.selectedSeats || [];
  useEffect(() => {
    setBooked({
      ...booked,
    ...
    <div className="min-h-screen bg-zinc-800 p-4 sm:p-6 lg:p-8 text-gray-800">
      ...
      <div className="bg-zinc-700 rounded-2xl shadow-sm p-6 mt-15 border border-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-100 pb-5 mb-6">
          ...
          <p className="text-lg font-semibold text-blue-600 bg-blue-50 px-4 py-1.5 rounded-xl border border-blue-100">
            {hr}:{min}
          </p>
        </div>
        <div className="p-2 sm:p-4">
          <p className="mb-4 text-xs font-bold text-white text-center border-b-2 border-gray-200 pb-2 max-w-md mx-auto">
            screen
          </p>
          ...
          <div className="border border-gray-200 flex flex-col md:flex-row gap-6 w-full max-w-2xl p-6 mx-auto rounded-xl bg-gray-50">
            ...
            <div className="ml-20 w-80">
              <h1 className="text-xs font-bold  text-gray-400 mb-2">
                Selected Seats
              </h1>
      ...
      <button
        ...
        className="mt-6 w-full bg-gray-900 hover:bg-gray-800 text-white font-bold py-3 px-6 rounded-xl text-center"
      >
        submit
      </button>
      <PopUpModel
