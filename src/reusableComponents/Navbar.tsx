...
<nav className="bg-neutral-primary text-blue fixed w-full z-20 top-0 start-0 border-b border-default">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <button type="button" onClick={userlogout} className="text-black bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none">logout</button>
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-default rounded-base bg-neutral-secondary-soft md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-neutral-primary">
        ...
        <li>
          <a  className="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent">Contact</a>
        </li>
      </ul>
    </div>
  </div>
        ...
        // <div classNameName="p-2 pt-0"><nav classNameName="bg-white p-0 sm:px-8 py-4">
        //         <ul classNameName="w-120 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:w-auto justify-center ">
        //             <li classNameName="text-blue-600 font-larger text-3xl">logo</li>
        //             <li classNameName="text-gray-600 font-medium ml-20"><NavLink to="/home">Home</NavLink></li>
        //             <li classNameName="text-gray-600 font-medium "><NavLink to="/allmovies">Movies</NavLink></li>
        //             <li classNameName="text-gray-600 font-medium ">content</li>        
        //             <li classNameName="text-gray-600 font-medium ml-5 mb-3"><input classNameName="mt-4 border border-black-50 w-80 rounded-md" placeholder="content"></input><i></i></li>
        //             <li classNameName="text-gray-600 font-medium ml-5"><button onClick={userlogout}>logout</button></li>
        //         </ul>
        //     </nav></div>
    )
}
